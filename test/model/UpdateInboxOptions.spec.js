...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpJavascriptApollo.UpdateInboxOptions();
  });
  ...
  describe('UpdateInboxOptions', function() {
    it('should create an instance of UpdateInboxOptions', function() {
      // uncomment below and update the code to test UpdateInboxOptions
      //var instane = new MailslurpJavascriptApollo.UpdateInboxOptions();
      //expect(instance).to.be.a(MailslurpJavascriptApollo.UpdateInboxOptions);
    });
