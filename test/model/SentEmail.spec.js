...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpJavascriptApollo.SentEmail();
  });
  ...
  describe('SentEmail', function() {
    it('should create an instance of SentEmail', function() {
      // uncomment below and update the code to test SentEmail
      //var instane = new MailslurpJavascriptApollo.SentEmail();
      //expect(instance).to.be.a(MailslurpJavascriptApollo.SentEmail);
    });
    ...
    it('should have the property bodyS3Key (base name: "bodyS3Key")', function() {
      // uncomment below and update the code to test the property bodyS3Key
      //var instane = new MailslurpJavascriptApollo.SentEmail();
      //expect(instance).to.be();
    });
