...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpJavascriptApollo.NameServerRecord();
  });
  ...
  describe('NameServerRecord', function() {
    it('should create an instance of NameServerRecord', function() {
      // uncomment below and update the code to test NameServerRecord
      //var instane = new MailslurpJavascriptApollo.NameServerRecord();
      //expect(instance).to.be.a(MailslurpJavascriptApollo.NameServerRecord);
    });
