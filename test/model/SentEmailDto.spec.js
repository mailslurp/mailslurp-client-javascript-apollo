...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpJavascriptApollo.SentEmailDto();
  });
  ...
  describe('SentEmailDto', function() {
    it('should create an instance of SentEmailDto', function() {
      // uncomment below and update the code to test SentEmailDto
      //var instane = new MailslurpJavascriptApollo.SentEmailDto();
      //expect(instance).to.be.a(MailslurpJavascriptApollo.SentEmailDto);
    });
