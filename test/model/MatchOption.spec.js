...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpJavascriptApollo.MatchOption();
  });
  ...
  describe('MatchOption', function() {
    it('should create an instance of MatchOption', function() {
      // uncomment below and update the code to test MatchOption
      //var instane = new MailslurpJavascriptApollo.MatchOption();
      //expect(instance).to.be.a(MailslurpJavascriptApollo.MatchOption);
    });
