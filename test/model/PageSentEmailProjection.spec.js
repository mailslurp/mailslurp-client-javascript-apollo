...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpJavascriptApollo.PageSentEmailProjection();
  });
  ...
  describe('PageSentEmailProjection', function() {
    it('should create an instance of PageSentEmailProjection', function() {
      // uncomment below and update the code to test PageSentEmailProjection
      //var instane = new MailslurpJavascriptApollo.PageSentEmailProjection();
      //expect(instance).to.be.a(MailslurpJavascriptApollo.PageSentEmailProjection);
    });
