...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpJavascriptApollo.PageEmailPreview();
  });
  ...
  describe('PageEmailPreview', function() {
    it('should create an instance of PageEmailPreview', function() {
      // uncomment below and update the code to test PageEmailPreview
      //var instane = new MailslurpJavascriptApollo.PageEmailPreview();
      //expect(instance).to.be.a(MailslurpJavascriptApollo.PageEmailPreview);
    });
