...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpJavascriptApollo.PageContactProjection();
  });
  ...
  describe('PageContactProjection', function() {
    it('should create an instance of PageContactProjection', function() {
      // uncomment below and update the code to test PageContactProjection
      //var instane = new MailslurpJavascriptApollo.PageContactProjection();
      //expect(instance).to.be.a(MailslurpJavascriptApollo.PageContactProjection);
    });
