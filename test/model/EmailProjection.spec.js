...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpJavascriptApollo.EmailProjection();
  });
  ...
  describe('EmailProjection', function() {
    it('should create an instance of EmailProjection', function() {
      // uncomment below and update the code to test EmailProjection
      //var instane = new MailslurpJavascriptApollo.EmailProjection();
      //expect(instance).to.be.a(MailslurpJavascriptApollo.EmailProjection);
    });
