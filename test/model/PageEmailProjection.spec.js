...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpJavascriptApollo.PageEmailProjection();
  });
  ...
  describe('PageEmailProjection', function() {
    it('should create an instance of PageEmailProjection', function() {
      // uncomment below and update the code to test PageEmailProjection
      //var instane = new MailslurpJavascriptApollo.PageEmailProjection();
      //expect(instance).to.be.a(MailslurpJavascriptApollo.PageEmailProjection);
    });
