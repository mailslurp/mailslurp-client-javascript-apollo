...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpJavascriptApollo.Inbox();
  });
  ...
  describe('Inbox', function() {
    it('should create an instance of Inbox', function() {
      // uncomment below and update the code to test Inbox
      //var instane = new MailslurpJavascriptApollo.Inbox();
      //expect(instance).to.be.a(MailslurpJavascriptApollo.Inbox);
    });
