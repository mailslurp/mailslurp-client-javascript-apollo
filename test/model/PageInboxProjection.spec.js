...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpJavascriptApollo.PageInboxProjection();
  });
  ...
  describe('PageInboxProjection', function() {
    it('should create an instance of PageInboxProjection', function() {
      // uncomment below and update the code to test PageInboxProjection
      //var instane = new MailslurpJavascriptApollo.PageInboxProjection();
      //expect(instance).to.be.a(MailslurpJavascriptApollo.PageInboxProjection);
    });
