...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpJavascriptApollo.AttachmentMetaData();
  });
  ...
  describe('AttachmentMetaData', function() {
    it('should create an instance of AttachmentMetaData', function() {
      ...
      //var instane = new MailslurpJavascriptApollo.AttachmentMetaData();
      //expect(instance).to.be.a(MailslurpJavascriptApollo.AttachmentMetaData);
    });
