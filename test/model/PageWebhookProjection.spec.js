...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpJavascriptApollo.PageWebhookProjection();
  });
  ...
  describe('PageWebhookProjection', function() {
    it('should create an instance of PageWebhookProjection', function() {
      // uncomment below and update the code to test PageWebhookProjection
      //var instane = new MailslurpJavascriptApollo.PageWebhookProjection();
      //expect(instance).to.be.a(MailslurpJavascriptApollo.PageWebhookProjection);
    });
