...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpJavascriptApollo.SentEmailProjection();
  });
  ...
  describe('SentEmailProjection', function() {
    it('should create an instance of SentEmailProjection', function() {
      // uncomment below and update the code to test SentEmailProjection
      //var instane = new MailslurpJavascriptApollo.SentEmailProjection();
      //expect(instance).to.be.a(MailslurpJavascriptApollo.SentEmailProjection);
    });
