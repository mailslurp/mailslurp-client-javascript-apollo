...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailslurpJavascriptApollo.PageAlias();
  });
  ...
  describe('PageAlias', function() {
    it('should create an instance of PageAlias', function() {
      // uncomment below and update the code to test PageAlias
      //var instane = new MailslurpJavascriptApollo.PageAlias();
      //expect(instance).to.be.a(MailslurpJavascriptApollo.PageAlias);
    });
