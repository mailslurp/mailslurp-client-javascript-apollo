...
describe('EmailControllerApi', function() {
    ...
    describe('downloadAttachmentBase64', function() {
      it('should call downloadAttachmentBase64 successfully', function(done) {
        //uncomment below and update the code to test downloadAttachmentBase64
        //instance.downloadAttachmentBase64(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getEmailContentMatch', function() {
      it('should call getEmailContentMatch successfully', function(done) {
        //uncomment below and update the code to test getEmailContentMatch
        //instance.getEmailContentMatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
