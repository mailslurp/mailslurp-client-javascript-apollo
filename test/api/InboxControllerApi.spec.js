...
describe('InboxControllerApi', function() {
    ...
    describe('sendEmailAndConfirm', function() {
      it('should call sendEmailAndConfirm successfully', function(done) {
        //uncomment below and update the code to test sendEmailAndConfirm
        //instance.sendEmailAndConfirm(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
