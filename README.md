...
*MailslurpJavascriptApollo.EmailControllerApi* | [**getEmailContentMatch**](docs/EmailControllerApi.md#getEmailContentMatch) | **GET** /emails/{emailId}/contentMatch | Get email content regex pattern match results. Runs regex against email body and returns match groups.
...
## Documentation for Models
 ...
 - [MailslurpJavascriptApollo.SentEmail](docs/SentEmail.md)
