...
let apiInstance = new MailslurpJavascriptApollo.EmailControllerApi();
let emailId = null; // String | ID of email to delete
...
let emailId = null; // String | ID of email
let opts = {
...
let apiInstance = new MailslurpJavascriptApollo.EmailControllerApi();
let emailId = null; // String | ID of email to match against
let contentMatchOptions = new MailslurpJavascriptApollo.ContentMatchOptions(); // ContentMatchOptions | contentMatchOptions
apiInstance.getEmailContentMatch(emailId, contentMatchOptions, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
