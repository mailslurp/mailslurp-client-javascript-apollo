...
import WebhookProjection from './WebhookProjection';

/**
 * The PageWebhookProjection model module.
 * @module model/PageWebhookProjection
 * @version 8.2.2
 */
class PageWebhookProjection {
    /**
     * @member {Array.<CodegenProperty{openApiType='WebhookProjection', baseName='content', complexType='WebhookProjection', getter='getContent', setter='setContent', description='null', dataType='WebhookProjection', datatypeWithEnum='WebhookProjection', dataFormat='null', name='content', min='null', max='null', defaultValue='null', defaultValueWithParam=' = WebhookProjection.constructFromObject(data['content']);', baseType='WebhookProjection', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='null', jsonSchema='{
  ...
  "$ref" : "#/components/schemas/WebhookProjection"
    ...
    /**
     * Constructs a new <code>PageWebhookProjection</code>.
     ...
     * @alias module:model/PageWebhookProjection
     */
    constructor() { 
        
        PageWebhookProjection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PageWebhookProjection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PageWebhookProjection} obj Optional instance to populate.
     * @return {module:model/PageWebhookProjection} The populated <code>PageWebhookProjection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PageWebhookProjection();

            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [WebhookProjection]);
            }
...
export default PageWebhookProjection;
