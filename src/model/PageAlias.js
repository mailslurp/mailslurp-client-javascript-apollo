...
class PageAlias {
    /**
     * @member {Array.<CodegenProperty{openApiType='Alias', baseName='content', complexType='Alias', getter='getContent', setter='setContent', description='null', dataType='Alias', datatypeWithEnum='Alias', dataFormat='null', name='content', min='null', max='null', defaultValue='null', defaultValueWithParam=' = Alias.constructFromObject(data['content']);', baseType='Alias', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='null', jsonSchema='{
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [Alias]);
            }
