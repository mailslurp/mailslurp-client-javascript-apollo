...
import TemplateProjection from './TemplateProjection';

/**
 * The PageTemplateProjection model module.
 * @module model/PageTemplateProjection
 * @version 8.0.21
 */
class PageTemplateProjection {
    /**
     * @member {Array.<CodegenProperty{openApiType='TemplateProjection', baseName='content', complexType='TemplateProjection', getter='getContent', setter='setContent', description='null', dataType='TemplateProjection', datatypeWithEnum='TemplateProjection', dataFormat='null', name='content', min='null', max='null', defaultValue='null', defaultValueWithParam=' = TemplateProjection.constructFromObject(data['content']);', baseType='TemplateProjection', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='null', jsonSchema='{
  ...
  "$ref" : "#/components/schemas/TemplateProjection"
    ...
    /**
     * Constructs a new <code>PageTemplateProjection</code>.
     * @alias module:model/PageTemplateProjection
     */
    constructor() { 
        
        PageTemplateProjection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PageTemplateProjection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PageTemplateProjection} obj Optional instance to populate.
     * @return {module:model/PageTemplateProjection} The populated <code>PageTemplateProjection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PageTemplateProjection();

            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [TemplateProjection]);
            }
...
export default PageTemplateProjection;
