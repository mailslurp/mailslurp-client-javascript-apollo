...
/**
 * The PageEmailPreview model module.
 * @module model/PageEmailPreview
 * @version 8.0.13
 */
class PageEmailPreview {
    /**
     * @member {Array.<CodegenProperty{openApiType='EmailPreview', baseName='content', complexType='EmailPreview', getter='getContent', setter='setContent', description='null', dataType='EmailPreview', datatypeWithEnum='EmailPreview', dataFormat='null', name='content', min='null', max='null', defaultValue='null', defaultValueWithParam=' = EmailPreview.constructFromObject(data['content']);', baseType='EmailPreview', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='null', jsonSchema='{
  ...
  "$ref" : "#/components/schemas/EmailPreview"
    ...
    /**
     * Constructs a new <code>PageEmailPreview</code>.
     * @alias module:model/PageEmailPreview
     */
    constructor() { 
        
        PageEmailPreview.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PageEmailPreview</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PageEmailPreview} obj Optional instance to populate.
     * @return {module:model/PageEmailPreview} The populated <code>PageEmailPreview</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PageEmailPreview();

            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [EmailPreview]);
            }
...
export default PageEmailPreview;
