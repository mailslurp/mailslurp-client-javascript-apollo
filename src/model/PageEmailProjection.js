...
import EmailProjection from './EmailProjection';
import Pageable from './Pageable';
import Sort from './Sort';

/**
 * The PageEmailProjection model module.
 * @module model/PageEmailProjection
 * @version 8.2.2
 */
class PageEmailProjection {
    /**
     * @member {Array.<CodegenProperty{openApiType='EmailProjection', baseName='content', complexType='EmailProjection', getter='getContent', setter='setContent', description='null', dataType='EmailProjection', datatypeWithEnum='EmailProjection', dataFormat='null', name='content', min='null', max='null', defaultValue='null', defaultValueWithParam=' = EmailProjection.constructFromObject(data['content']);', baseType='EmailProjection', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='null', jsonSchema='{
  ...
  "$ref" : "#/components/schemas/EmailProjection"
    ...
    /**
     * Constructs a new <code>PageEmailProjection</code>.
     * Paginated email projection results. EmailProjections and EmailPreviews are essentially the same but have legacy naming issues. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full email entity use the projection ID with individual method calls. For emails there are several methods for fetching message bodies and attachments.
     * @alias module:model/PageEmailProjection
     */
    constructor() { 
        
        PageEmailProjection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PageEmailProjection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PageEmailProjection} obj Optional instance to populate.
     * @return {module:model/PageEmailProjection} The populated <code>PageEmailProjection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PageEmailProjection();

            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [EmailProjection]);
            }
...
export default PageEmailProjection;
