...
/**
 * The UpdateInboxOptions model module.
 * @module model/UpdateInboxOptions
 * @version 8.2.14
 */
class UpdateInboxOptions {
  ...
  "type" : "string"
    ...
    /**
     * Constructs a new <code>UpdateInboxOptions</code>.
     * Options for updating inbox properties
     * @alias module:model/UpdateInboxOptions
     */
    constructor() { 
        
        UpdateInboxOptions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateInboxOptions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateInboxOptions} obj Optional instance to populate.
     * @return {module:model/UpdateInboxOptions} The populated <code>UpdateInboxOptions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateInboxOptions();
...
export default UpdateInboxOptions;
