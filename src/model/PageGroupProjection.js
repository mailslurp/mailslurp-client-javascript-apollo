...
/**
 * The PageGroupProjection model module.
 * @module model/PageGroupProjection
 * @version 8.0.14
 */
class PageGroupProjection {
    /**
     * @member {Array.<CodegenProperty{openApiType='GroupProjection', baseName='content', complexType='GroupProjection', getter='getContent', setter='setContent', description='null', dataType='GroupProjection', datatypeWithEnum='GroupProjection', dataFormat='null', name='content', min='null', max='null', defaultValue='null', defaultValueWithParam=' = GroupProjection.constructFromObject(data['content']);', baseType='GroupProjection', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='null', jsonSchema='{
  ...
  "$ref" : "#/components/schemas/GroupProjection"
    ...
    /**
     * Constructs a new <code>PageGroupProjection</code>.
     * @alias module:model/PageGroupProjection
     */
    constructor() { 
        
        PageGroupProjection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PageGroupProjection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PageGroupProjection} obj Optional instance to populate.
     * @return {module:model/PageGroupProjection} The populated <code>PageGroupProjection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PageGroupProjection();

            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [GroupProjection]);
            }
...
export default PageGroupProjection;
