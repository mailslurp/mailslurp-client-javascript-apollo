...
import SentEmail from '../model/SentEmail';
...
export default class InboxControllerApi extends ApiClient {
    ...
    */
     ...
     * @param {Object} opts Optional parameters
     * @param {SendEmailOptions} opts.sendEmailOptions Options for the email
     * @return {Promise<SentEmail>}
     */
    async sendEmailAndConfirm(inboxId, opts) {
      opts = opts || {};
      let postBody = opts['sendEmailOptions'];
      // verify the required parameter 'inboxId' is set
      if (inboxId === undefined || inboxId === null) {
        throw new Error("Missing the required parameter 'inboxId' when calling sendEmailAndConfirm");
      }
